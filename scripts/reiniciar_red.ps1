...
Start-Process -FilePath ".\ipv7.exe" -ArgumentList "--role master --port 7778 --api-port 7781 --tun=true --sub-port 0" -Verb RunAs
...
Start-Process -FilePath ".\ipv7.exe" -ArgumentList "--role node --port 7779 --api-port 7782 --tun=true --bootstrap 127.0.0.1:8778 --remote 127.0.0.1 --remote-port 7778 --sub-port 1" -Verb RunAs
